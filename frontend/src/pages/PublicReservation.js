    ...
    return (
      ...
      >
        <div className="max-w-md w-full bg-[#1e293b] border border-[#334155] rounded-lg p-8 text-center">
          ...
          <h2 className="text-3xl font-heading font-bold text-white mb-4">RESERVA CONFIRMADA</h2>
          <div className="bg-[#0f172a] p-6 rounded-lg mb-6 text-left">
            <p className="text-[#94a3b8] mb-2"><strong className="text-white">Nome:</strong> {reservation?.name}</p>
            <p className="text-[#94a3b8] mb-2"><strong className="text-white">Data:</strong> {reservation?.date}</p>
            <p className="text-[#94a3b8] mb-2"><strong className="text-white">Hora:</strong> {reservation?.time}</p>
            <p className="text-[#94a3b8] mb-2"><strong className="text-white">Pessoas:</strong> {reservation?.guests}</p>
            {reservation?.table_id && (
              <p className="text-[#94a3b8]"><strong className="text-white">Mesa:</strong> {reservation.table_id}</p>
            )}
          </div>
          <p className="text-[#94a3b8] mb-6">Aguardamos por si!</p>
          <Button
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b]">
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute bottom-6 left-4 right-4">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-white uppercase tracking-tight">Reserve a sua mesa</h1>
        </div>
      </div>
      ...
      >
        <form onSubmit={handleSubmit} className="bg-[#1e293b] border border-[#334155] rounded-lg p-6 md:p-8 space-y-6">
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="phone" className="text-[#f8fafc] mb-2 block">Telefone *</Label>
            ...
            <div>
              <Label htmlFor="email" className="text-[#f8fafc] mb-2 block">Email (opcional)</Label>
              <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="guests" className="text-[#f8fafc] mb-2 block">Pessoas *</Label>
                <div className="relative">
              ...
              <div>
                <Label htmlFor="date" className="text-[#f8fafc] mb-2 block">Data *</Label>
                <div className="relative">
            ...
            <div>
              <Label htmlFor="time" className="text-[#f8fafc] mb-2 block">Hora *</Label>
              <div className="relative">
            ...
            <div>
              <Label htmlFor="notes" className="text-[#f8fafc] mb-2 block">Observações</Label>
              <Textarea
                id="notes"
